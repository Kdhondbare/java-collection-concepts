...
public class ComparatorExample {
    ...
    public static void main(String[] args) {
        ...
        employeeList.add(new Employee("Vikram", 100, 13000));
        employeeList.add(new Employee("Karan", 100, 12000));
        employeeList.add(new Employee("Karan", 100, 11000));
        employeeList.add(new Employee("Moin", 500, 30000));
        employeeList.add(new Employee("Pratik", 200, 12000));
        employeeList.add(new Employee("Komal", 100, 10000));
     ...
     //   Comparator<Employee> nameComparator = idComparator.thenComparing(Employee::getName);
        //Use thenComparing to add secondary sorting by salary
